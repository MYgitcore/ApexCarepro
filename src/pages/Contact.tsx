...
<div className="mt-10 pt-8 border-t border-gray-200">
  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
    ...
    <div className="flex flex-col items-center p-3 rounded-xl bg-blue-50/50 hover:bg-blue-50 transition-all group">
      <div className="w-12 h-12 bg-blue-600/10 rounded-full flex items-center justify-center mb-2 group-hover:scale-110 transition-all">
        <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
      </div>
      <span className="text-sm font-bold text-slate-700">NADCA Certified</span>
    ...
    <div className="flex flex-col items-center p-3 rounded-xl bg-blue-50/50 hover:bg-blue-50 transition-all group">
      ...
      <span className="text-xs text-slate-500">Full Protection</span>
    </div>

    {/* Badge 3: 5-Star Service */}
    <div className="flex flex-col items-center p-3 rounded-xl bg-blue-50/50 hover:bg-blue-50 transition-all group">
      <div className="w-12 h-12 bg-yellow-500/10 rounded-full flex items-center justify-center mb-2 group-hover:scale-110 transition-all">
        <svg className="w-6 h-6 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
          <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
        </svg>
      </div>
      <span className="text-sm font-bold text-slate-700">5-Star Service</span>
      <span className="text-xs text-slate-500">★★★★★ 4.9/5</span>
    </div>

    {/* Badge 4: No Hidden Charges */}
    <div className="flex flex-col items-center p-3 rounded-xl bg-blue-50/50 hover:bg-blue-50 transition-all group">
      <div className="w-12 h-12 bg-green-500/10 rounded-full flex items-center justify-center mb-2 group-hover:scale-110 transition-all">
        <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
        </svg>
      </div>
      <span className="text-sm font-bold text-slate-700">No Hidden Charges</span>
      <span className="text-xs text-slate-500">Pay After Job Done</span>
    </div>
