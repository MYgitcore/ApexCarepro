...
export default function FloatingWhatsAppButton() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-[20px] right-[20px] z-[60] w-16 h-16 bg-blue-500 text-white rounded-full flex items-center justify-center shadow-2xl transition-colors hover:bg-blue-600"
